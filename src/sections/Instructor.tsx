...
import { Mail, MapPin, Clock, Building, Phone } from 'lucide-react';
                ...
                <div className="p-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-slate-400 text-sm">联系电话</p>
                        <a
                          href="tel:18950057128"
                          className="text-white hover:text-cyan-400 transition-colors"
                        >
                          18950057128
                        </a>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-white">海琴三A526</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-white">周四 9-11 节</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 pt-6 border-t border-slate-800">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-white">教学大楼珠海 A303</p>
                      </div>
                    </div>
                  </div>
                </div>
